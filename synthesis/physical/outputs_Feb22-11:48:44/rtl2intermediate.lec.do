...
usage -auto -elapse
set log file logs_Feb22-11:48:44/rtl2intermediate.lec.log -replace
tclmode
...
vpx read design -verilog -revised -lastmod -noelab \
	outputs_Feb22-11:48:44/neo430_top_intermediate.v
} else {
...
write hier_compare dofile outputs_Feb22-11:48:44/hier_rtl2intermediate.lec.do \
...
run hier_compare outputs_Feb22-11:48:44/hier_rtl2intermediate.lec.do -dynamic_hierarchy
